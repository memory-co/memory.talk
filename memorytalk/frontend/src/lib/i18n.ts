...
const en = {
  ...
  'user.guest': 'Guest',
  'nav.home': 'Workbench', 'nav.library': 'Library', 'nav.settings': 'Settings', 'nav.workspace': 'Workspace', 'nav.main': 'Main navigation',
  'nav.mainText': 'Switch works, browse the library, or open settings.', 'nav.closeNav': 'Close navigation', 'nav.openNav': 'Open navigation', 'nav.toggleSidebar': 'Toggle sidebar', 'nav.homeLink': 'memory.talk home', 'nav.newWork': 'New work', 'nav.searchWork': 'Search works', 'nav.yourWorks': 'Your works',
  ...
  'nav.openInspector': 'Open library panel', 'nav.closeInspector': 'Hide library panel', 'nav.inspector': 'Library panel', 'nav.closeInspectorPanel': 'Close library panel',
  ...
  'home.hintEnter': 'Enter to create', 'home.hintShift': 'Shift + Enter for a new line', 'home.fromLibrary': 'Start from the library',
...
const zh: Record<Key, string> = {
  ...
  'user.guest': '访客',
  'nav.home': '工作台', 'nav.library': '认知库', 'nav.settings': '设置', 'nav.workspace': '工作空间', 'nav.main': '主导航',
  'nav.mainText': '切换工作、浏览认知库或打开设置。', 'nav.closeNav': '收起导航', 'nav.openNav': '打开导航', 'nav.toggleSidebar': '切换侧栏', 'nav.homeLink': 'memory.talk 首页', 'nav.newWork': '新建工作', 'nav.searchWork': '搜索工作', 'nav.yourWorks': '你的工作',
  ...
  'nav.openInspector': '打开认知库面板', 'nav.closeInspector': '收起认知库面板', 'nav.inspector': '认知库面板', 'nav.closeInspectorPanel': '关闭认知库面板',
  ...
  'home.hintEnter': 'Enter 创建工作', 'home.hintShift': 'Shift + Enter 换行', 'home.fromLibrary': '从已有认知出发',
