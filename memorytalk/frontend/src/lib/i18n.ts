...
const en = {
  ...
  'work.statusLabel': 'Work status', 'work.split': 'Split work', 'work.worklets': 'Worklets', 'work.addSession': 'Add worklet', 'work.column': 'Column {n}', 'work.addColumn': 'Add column', 'work.removeColumn': 'Remove this empty column', 'work.collapseColumn': 'Collapse column', 'work.expandColumn': 'Expand column',
  ...
  'attach.opening': 'Opening worklet…', 'attach.open': 'Open worklet',
...
const zh: Record<Key, string> = {
  ...
  'work.statusLabel': '工作状态', 'work.split': '拆分工作', 'work.worklets': '工作单元', 'work.addSession': '添加工作单元', 'work.column': '第 {n} 列', 'work.addColumn': '添加一列', 'work.removeColumn': '删掉这一空列', 'work.collapseColumn': '收起这一列', 'work.expandColumn': '展开这一列',
  ...
  'attach.opening': '正在建立工作单元…', 'attach.open': '打开工作单元',
