...
const en = {
  ...
  'nav.mainText': 'Switch works, browse the library, or open settings.', 'nav.toggleSidebar': 'Toggle sidebar', 'nav.homeLink': 'memory.talk home', 'nav.newWork': 'New work', 'nav.searchWork': 'Search works', 'nav.yourWorks': 'Your works',
...
const zh: Record<Key, string> = {
  ...
  'nav.mainText': '切换工作、浏览认知库或打开设置。', 'nav.toggleSidebar': '切换侧栏', 'nav.homeLink': 'memory.talk 首页', 'nav.newWork': '新建工作', 'nav.searchWork': '搜索工作', 'nav.yourWorks': '你的工作',
