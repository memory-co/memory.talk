...
const zh = {
  ...
  'layer.origin': '原文', 'layer.issue': '问题', 'layer.card': '卡片',
  'scheme.bash': '终端', 'scheme.http': '网页', 'scheme.https': '网页',
  'user.guest': '访客',
  'nav.home': '工作台', 'nav.library': '认知库', 'nav.settings': '设置', 'nav.workspace': '工作空间', 'nav.skip': '跳转到主要内容', 'nav.main': '主导航',
  'nav.mainText': '切换工作、浏览认知库或打开设置。', 'nav.toggleSidebar': '切换侧栏', 'nav.homeLink': 'memory.talk 首页', 'nav.closeNav': '收起导航', 'nav.collapseSidebar': '收起侧栏',
  'nav.openNav': '打开导航', 'nav.expandSidebar': '展开侧栏', 'nav.newWork': '新建工作', 'nav.searchWork': '搜索工作', 'nav.yourWorks': '你的工作',
  'nav.noWorks': '还没有工作', 'nav.noWorksHint': '从一个想法开始。', 'nav.connected': '工作空间已连接', 'nav.disconnected': '工作空间未连接', 'nav.connecting': '正在连接工作空间',
  'nav.teamWorkspace': '团队工作空间', 'nav.chooseIdentity': '选择或添加你的身份', 'nav.workSubtitle': '专注当下的这件事', 'nav.subtitle': '做事，也留下认知',
  'nav.openInspector': '打开认知库面板', 'nav.closeInspector': '收起认知库面板', 'nav.inspector': '认知库面板', 'nav.openLibraryPage': '在主页面打开认知库', 'nav.closeInspectorPanel': '关闭认知库面板',
  'search.title': '搜索工作', 'search.description': '输入工作名称，使用上下方向键选择，按 Enter 打开。', 'search.placeholder': '输入工作名称…', 'search.inputLabel': '搜索工作名称',
  'search.loading': '正在加载工作…', 'search.empty': '没有找到匹配的工作。',
  ...
  'home.startHint': '从一个目标开始', 'home.splitHint': '拆分为子工作', 'home.create': '创建工作', 'home.subworkTitle': '拆分一步，继续推进', 'home.subworkDescription': '子工作会保留在当前工作下，拥有独立的会话。',
  'home.eyebrow': '每一次开始，都有所积累', 'home.greeting': '今天想做些什么？', 'home.greetingNamed': '{name}，今天想做些什么？', 'home.description': '让工作发生，让认知留下。',
  'home.hintEnter': 'Enter 创建工作', 'home.hintShift': 'Shift + Enter 换行', 'home.startWork': '开始一个工作', 'home.fromLibrary': '从已有认知出发',
  'home.recent': '继续最近的工作', 'home.recentNote': '接着上次的思路', 'home.searching': '正在寻找你的工作…', 'home.emptyTitle': '留一个起点给未来的自己',
  'home.emptyText': '创建第一项工作后，你可以随时从这里继续。', 'home.footer': '工作在这里发生，记忆随之生长',
  ...
  'work.readyText': '添加一个 agent、终端或网页，让思路开始落地。', 'work.viewLibrary': '查看认知库',
  ...
  'settings.subtitle': '选择你的身份，连接你的工作环境。', 'settings.identity': '当前身份', 'settings.identityText': '用于标记工作参与者和认知库的提交作者。', 'settings.anonymous': '暂不署名',
  ...
  'settings.ttydArg': '窗口地址会携带', 'settings.ttydSocket': '。当前 tmux socket：', 'settings.ttydRestart': '。修改配置后需要重启后端。', 'settings.footer': '做事 · 议事 · 记事',
  ...
  'library.subtitle': '工作中的原文、问题与结论，在这里逐渐连接。', 'library.layers': '认知层', 'library.new': '新建{layer}', 'library.searchLabel': '搜索认知库', 'library.searchPlaceholder': '搜索{layer}内容…',
...
const en: Record<Key, string> = {
  ...
  'layer.origin': 'Origin', 'layer.issue': 'Issue', 'layer.card': 'Card',
  'scheme.bash': 'Terminal', 'scheme.http': 'Web', 'scheme.https': 'Web',
  'user.guest': 'Guest',
  'nav.home': 'Workbench', 'nav.library': 'Library', 'nav.settings': 'Settings', 'nav.workspace': 'Workspace', 'nav.skip': 'Skip to main content', 'nav.main': 'Main navigation',
  'nav.mainText': 'Switch works, browse the library, or open settings.', 'nav.toggleSidebar': 'Toggle sidebar', 'nav.homeLink': 'memory.talk home', 'nav.closeNav': 'Close navigation', 'nav.collapseSidebar': 'Collapse sidebar',
  'nav.openNav': 'Open navigation', 'nav.expandSidebar': 'Expand sidebar', 'nav.newWork': 'New work', 'nav.searchWork': 'Search works', 'nav.yourWorks': 'Your works',
  ...
  'nav.teamWorkspace': 'Team workspace', 'nav.chooseIdentity': 'Choose or add your identity', 'nav.workSubtitle': 'Focus on this one thing', 'nav.subtitle': 'Get things done, keep what you learned',
  'nav.openInspector': 'Open library panel', 'nav.closeInspector': 'Hide library panel', 'nav.inspector': 'Library panel', 'nav.openLibraryPage': 'Open the library page', 'nav.closeInspectorPanel': 'Close library panel',
  'search.title': 'Search works', 'search.description': 'Type a work name, use the arrow keys to select, and press Enter to open.', 'search.placeholder': 'Type a work name…', 'search.inputLabel': 'Search work names',
  'search.loading': 'Loading works…', 'search.empty': 'No matching works.',
  ...
  'home.startHint': 'Start from a goal', 'home.splitHint': 'Split into a sub-work', 'home.create': 'Create work', 'home.subworkTitle': 'Split off a step and keep going', 'home.subworkDescription': 'The sub-work stays under the current work and has its own sessions.',
  'home.eyebrow': 'Every start adds up', 'home.greeting': 'What do you want to do today?', 'home.greetingNamed': '{name}, what do you want to do today?', 'home.description': 'Let the work happen, and let the knowledge stay.',
  'home.hintEnter': 'Enter to create', 'home.hintShift': 'Shift + Enter for a new line', 'home.startWork': 'Start a work', 'home.fromLibrary': 'Start from the library',
  'home.recent': 'Continue recent work', 'home.recentNote': 'Pick up where you left off', 'home.searching': 'Looking for your works…', 'home.emptyTitle': 'Leave a starting point for your future self',
  'home.emptyText': 'Once you create your first work, you can always continue from here.', 'home.footer': 'Work happens here, and memory grows with it',
  ...
  'work.readyText': 'Add an agent, a terminal, or a web page to get the ideas moving.', 'work.viewLibrary': 'Open library',
  ...
  'settings.subtitle': 'Choose your identity and connect your environment.', 'settings.identity': 'Identity', 'settings.identityText': 'Used to mark work participants and as the commit author in the library.', 'settings.anonymous': 'Not signed',
  ...
  'settings.ttydArg': 'The window address carries', 'settings.ttydSocket': '. Current tmux socket: ', 'settings.ttydRestart': '. Restart the backend after changing it.', 'settings.footer': 'do · discuss · record',
  ...
  'library.subtitle': 'Sources, questions and conclusions from your work, gradually connected.', 'library.layers': 'Layers', 'library.new': 'New {layer}', 'library.searchLabel': 'Search library', 'library.searchPlaceholder': 'Search {layer} content…',
...
export function translate(locale: Locale, key: Key, vars?: Record<string, string | number>): string {
  let text = dictionaries[locale][key] ?? zh[key] ?? key;
