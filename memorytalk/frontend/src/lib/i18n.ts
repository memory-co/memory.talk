...
const en = {
  ...
  'work.statusLabel': 'Work status', 'work.split': 'Split work', 'work.sessions': 'Work sessions', 'work.addSession': 'Add session', 'work.column': 'Column {n}', 'work.addColumn': 'Add column', 'work.removeColumn': 'Remove column (sessions move to the left)',
  ...
  'library.revision': 'Revision {rev}', 'library.backToCurrent': 'Back to current', 'library.viewDiscussion': 'View the discussion of this card', 'library.relatedCards': 'Related cards', 'library.positions': 'Positions and arguments',
...
const zh: Record<Key, string> = {
  ...
  'work.statusLabel': '工作状态', 'work.split': '拆分工作', 'work.sessions': '工作会话', 'work.addSession': '添加会话', 'work.column': '第 {n} 列', 'work.addColumn': '添加一列', 'work.removeColumn': '删掉这一列（会话并到左边）',
  ...
  'library.revision': '历史版本 {rev}', 'library.backToCurrent': '回到当前版本', 'library.viewDiscussion': '查看这张卡片的讨论', 'library.relatedCards': '相关卡片', 'library.positions': '立场与论证',
