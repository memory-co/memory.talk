...
def _render_md_to(stream, text: str) -> None:
    if stream.isatty():
        ...
        class _FlatHeading(Heading):
            ...
            rich's default Heading hard-codes H1 as a centered Panel and
            H2 as centered text. With long ULID-bearing titles like
            ``CARD card_01KQ12E6R43JXMFDEKZ0292ZKZ``, centering pushes
            content off the left margin. Override to flush-left.
            """
