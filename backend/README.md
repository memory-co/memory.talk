...
│   ├── collect.py            #   LayerInfo / Obj / Revision / SearchHit / Catalog / Tree / Manager / InboxItem
...
│       └── (git 的部分在 services/collect/repo.py)
│
...
│   ├── collect.py            #   /api/collect/…(层、树、检索、manager、对象 CRUD、历史、行为)
