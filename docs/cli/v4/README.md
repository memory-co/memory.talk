...
memory.talk card review --position pos_01jzr5kq --argument +1 --cite sess_ghi:20-25 --comment '又一次验证,简洁版接住了'
...
memory.talk card position --card card_01jz8k2m \
    ...
    --source sess_xyz:4-9
memory.talk card review --position pos_OLD --argument -1 --cite sess_xyz:4-9 --comment '纯简洁漏了细节场景'
```
