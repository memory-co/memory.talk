...
- **v4 的 read / search / recall / list 端点不再有 v5 对应**——都是 [query](query.md) 上的一条 SQL;CLI 也只有三命令(query / sync / harness,见 [cli/v5](../../cli/v5/README.md)),人写 mind 走 `harness chat`(说给管家),不直接调写动作;
