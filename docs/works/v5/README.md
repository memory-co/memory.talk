...
| query-interface 查询层(把 card / session 以 **SQL 直接暴露**:表结构即 API;两库分治总述 + schema 原则 + `semantic()` 表函数 + 暴露面;SQL 全只读;入口按库分、可见性不对称:mind 附带 reality、reality 独立) | [query-interface.md](query-interface.md) |
