"""Dated jsonl writer for v2 audit logs (search). Async via aiofiles."""
...
class DatedJsonlWriter:
    ...
    async def append(self, record: dict, now: datetime | None = None) -> None:
    ...
    def iter_files(self) -> Iterator[Path]:
        """Sync — directory listing is cheap, only used for rebuild/retention."""
