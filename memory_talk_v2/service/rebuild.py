...
File layer (sessions/, cards/, links/, logs/search/*.jsonl) is the source
of truth. Object TTLs (expires_at) come from files unchanged.
Events live inside each object's own events.jsonl and need no replay.
"""
